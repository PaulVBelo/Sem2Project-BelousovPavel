  ...
  public void processOutbox() {
    ...
    for (OutboxRecord record: result) {
      ...
      try {
        ...
        throw new OutboxSchedulingException("Couldn't send message to Kafka", e);
      } catch (TimeoutException e) {
        throw new OutboxSchedulingException("Couldn't send message to Kafka due to timeout", e);
      }
    }
